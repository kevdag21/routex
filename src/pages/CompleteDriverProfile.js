...
import { validateDrivingLicense, validateName, validatePhone, validateVehicleInputs, validateCity } from '../utils/validateInputs.js'
  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        ...
        />
        <InputStyled name="email" value={userData.email} disabled />
        <InputStyled
          name="phone"
...
export function CompleteDriverProfile () {
  ...
  return (
    <AllInfoContex.Provider value={{ allInfo, setAllInfo }}>
      <Stack.Navigator>
        <Stack.Screen
          name='DriverInfo' component={DriverInfo} options={{
            headerShown: false
          }}
        />
        <Stack.Screen
          name='VehicleInfo' component={VehicleInfo} options={{
